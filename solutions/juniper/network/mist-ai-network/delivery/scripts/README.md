...
This directory contains deployment automation scripts for JUNIPER Mist Ai Network solution using Cloud services. The scripts work together in a specific sequence to create a complete network solution.
...
export PROJECT_NAME="mist_ai_network"
...
The deployed Mist Ai Network solution provides the following capabilities:
