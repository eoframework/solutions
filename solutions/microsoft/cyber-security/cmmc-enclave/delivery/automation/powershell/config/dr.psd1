# CMMC GCC High Enclave - DR Configuration
# Generated from configuration.csv - do not edit directly
# Regenerate using: generate-powershell-config.py --environment dr
...
@{
    ...
    # ===========================================================================
    security = @{
        sentinel_workspace_name     = 'cmmc-sentinel-dr'
    ...
    # ===========================================================================
    network = @{
        vnet_cidr                   = '10.102.0.0/16'
        management_subnet           = '10.102.1.0/24'
        cui_workload_subnet         = '10.102.10.0/24'
        private_endpoint_subnet     = '10.102.20.0/24'
