...
```json
{
  ...
  "policyDefinitions": [
    {
      "policyDefinitionId": "/solutions/Microsoft.Management/managementGroups/mg/solutions/Microsoft.Authorization/policyDefinitions/ac-1-001-limit-system-access",
      "parameters": {
        "effect": "Audit",
        "requireMFA": true,
    ...
    {
      "policyDefinitionId": "/solutions/Microsoft.Management/managementGroups/mg/solutions/Microsoft.Authorization/policyDefinitions/au-2-042-audit-logs",
      "parameters": {
  ...
  "alertRules": [
    {
      ...
      "actionGroups": [
        {
          "actionGroupId": "/subscriptions/{subscription}/resourceGroups/{rg}/solutions/Microsoft.Insights/actionGroups/CMMC-Security-Team",
...
```json
{
  ...
  "properties": {
    ...
    "networkAcls": {
      ...
      "virtualNetworkRules": [
        {
          "id": "/subscriptions/{subscription}/resourceGroups/{rg}/solutions/Microsoft.Network/virtualNetworks/cmmc-vnet/subnets/data-subnet",
  ...
  "diagnosticSettings": {
    ...
    "workspaceId": "/subscriptions/{subscription}/resourceGroups/{rg}/solutions/Microsoft.OperationalInsights/workspaces/cmmc-log-analytics"
  }
}
```
