# MICROSOFT Cmmc Enclave - Deployment Scripts

## Overview

This directory contains deployment automation scripts for MICROSOFT Cmmc Enclave solution using Cloud services. The scripts work together in a specific sequence to create a complete cyber-security solution.
...
export PROJECT_NAME="cmmc_enclave"
...
The deployed Cmmc Enclave solution provides the following capabilities:
