# AWS Disaster Recovery Web Application - Deployment Scripts

## Overview

This directory contains deployment automation scripts for AWS Disaster Recovery Web Application solution using AWS CloudFormation, EC2. The scripts work together in a specific sequence to create a complete cloud solution.
...
- Service-specific permissions (EC2, S3, Lambda, etc.)
...
export PROJECT_NAME="disaster_recovery_web_application"
...
The deployed Disaster Recovery Web Application solution provides the following capabilities:
...
aws cloudformation describe-stacks --stack-name $PROJECT_NAME
