# AWS Onpremise To Cloud Migration - Deployment Scripts

## Overview

This directory contains deployment automation scripts for AWS Onpremise To Cloud Migration solution using AWS DMS, Server Migration. The scripts work together in a specific sequence to create a complete cloud solution.
...
export PROJECT_NAME="onpremise_to_cloud_migration"
...
The deployed Onpremise To Cloud Migration solution provides the following capabilities:
