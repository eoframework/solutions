...
compute = {
  ...
  api_throttle_burst = 1000  # API burst limit
  api_throttle_rate = 500  # API steady-state rate
  enable_xray = true  # Enable X-Ray tracing
  lambda_memory = 1024  # Lambda memory (MB)
  lambda_provisioned_concurrency = 25  # Provisioned concurrency
