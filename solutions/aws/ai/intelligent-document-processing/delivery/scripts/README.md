# AWS Intelligent Document Processing - Deployment Scripts

## Overview

This directory contains deployment automation scripts for AWS Intelligent Document Processing solution using Amazon Textract, Comprehend. The scripts work together in a specific sequence to create a complete ai solution.
...
export PROJECT_NAME="intelligent_document_processing"
...
The deployed Intelligent Document Processing solution provides the following capabilities:
