#------------------------------------------------------------------------------
# Sessionhost Configuration - TEST Environment
#------------------------------------------------------------------------------
...
sessionhost = {
  accelerated_networking = false  # Enable accelerated networking
  ...
  vm_size = "Standard_D2s_v5"  # Azure VM size for session hosts
}
