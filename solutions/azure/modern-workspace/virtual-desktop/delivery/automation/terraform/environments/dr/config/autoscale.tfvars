#------------------------------------------------------------------------------
# Autoscale Configuration - DR Environment
#------------------------------------------------------------------------------
...
autoscale = {
  enabled = true  # Enable auto-scaling for session hosts
  max_hosts = 5  # Maximum number of session hosts
  min_hosts = 1  # Minimum number of session hosts
  off_peak_start = "19:00"  # Off-peak hours start time (HH:MM)
  ...
  ramp_up_start = "07:00"  # Ramp up start time (HH:MM)
  # Scale down when utilization below percentage
  scale_down_threshold = 20
  # Scale up when utilization exceeds percentage
  scale_up_threshold = 80
  timezone = "Pacific Standard Time"  # Timezone for scaling schedule
}
