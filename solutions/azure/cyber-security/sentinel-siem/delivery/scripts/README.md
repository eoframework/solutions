# AZURE Sentinel Siem - Deployment Scripts

## Overview

This directory contains deployment automation scripts for AZURE Sentinel Siem solution using Cloud services. The scripts work together in a specific sequence to create a complete cyber-security solution.
...
export PROJECT_NAME="sentinel_siem"
...
The deployed Sentinel Siem solution provides the following capabilities:
