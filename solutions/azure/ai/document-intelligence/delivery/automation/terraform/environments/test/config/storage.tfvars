...
storage = {
  ...
  retention_cool_days = 14  # Days in cool tier before archive
  retention_hot_days = 7  # Days in hot tier before transition
  retention_total_days = 90  # Total retention in days (7 years)
}
