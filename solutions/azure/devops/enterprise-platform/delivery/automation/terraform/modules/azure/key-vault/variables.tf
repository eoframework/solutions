...
variable "secrets" {
  ...
  default = {}
  # Note: Individual secret values are sensitive but the map itself cannot be
  # marked sensitive as for_each doesn't support sensitive iterables.
  # Secret values are protected at the azurerm_key_vault_secret resource level.
}
