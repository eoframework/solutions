# DELL Safeid Authentication - Deployment Scripts

## Overview

This directory contains deployment automation scripts for DELL Safeid Authentication solution using Cloud services. The scripts work together in a specific sequence to create a complete cyber-security solution.
...
export PROJECT_NAME="safeid_authentication"
...
The deployed Safeid Authentication solution provides the following capabilities:
