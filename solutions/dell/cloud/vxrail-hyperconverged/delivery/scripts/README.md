# DELL Vxrail Hyperconverged - Deployment Scripts

## Overview

This directory contains deployment automation scripts for DELL Vxrail Hyperconverged solution using Cloud services. The scripts work together in a specific sequence to create a complete cloud solution.
...
export PROJECT_NAME="vxrail_hyperconverged"
...
The deployed Vxrail Hyperconverged solution provides the following capabilities:
