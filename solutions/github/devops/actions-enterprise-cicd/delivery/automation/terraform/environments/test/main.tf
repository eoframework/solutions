#------------------------------------------------------------------------------
# GitHub Actions Enterprise CI/CD - Test Environment
#------------------------------------------------------------------------------
# Test/Development CI/CD platform configuration including:
# - GitHub organization Actions configuration
# - Self-hosted runner autoscaling groups (reduced capacity)
# - Container registry integration
# - Environment-based deployment governance (relaxed)
#------------------------------------------------------------------------------
