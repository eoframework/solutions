# GITHUB Actions Enterprise Cicd - Deployment Scripts

## Overview

This directory contains deployment automation scripts for GITHUB Actions Enterprise Cicd solution using Cloud services. The scripts work together in a specific sequence to create a complete devops solution.
...
export PROJECT_NAME="actions_enterprise_cicd"
...
The deployed Actions Enterprise Cicd solution provides the following capabilities:
