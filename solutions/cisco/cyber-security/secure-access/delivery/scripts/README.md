# CISCO Secure Access - Deployment Scripts

## Overview

This directory contains deployment automation scripts for CISCO Secure Access solution using Cloud services. The scripts work together in a specific sequence to create a complete cyber-security solution.
...
export PROJECT_NAME="secure_access"
...
The deployed Secure Access solution provides the following capabilities:
