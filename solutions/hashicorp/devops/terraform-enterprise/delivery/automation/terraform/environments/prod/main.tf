#------------------------------------------------------------------------------
# HashiCorp Terraform Enterprise - Production Environment
#------------------------------------------------------------------------------
# Enterprise-grade Terraform platform deployment:
# - Terraform Enterprise on AWS EKS for centralized IaC
...
#------------------------------------------------------------------------------
# Run Tasks (optional validation hooks)
#------------------------------------------------------------------------------
module "run_tasks" {
  source = "../../modules/tfe/run-task"
  count  = var.integration.servicenow_enabled || var.integration.slack_enabled ? 1 : 0
