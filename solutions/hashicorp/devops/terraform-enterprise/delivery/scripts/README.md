...
This directory contains deployment automation scripts for HASHICORP Terraform Enterprise solution using Cloud services. The scripts work together in a specific sequence to create a complete devops solution.
...
export PROJECT_NAME="terraform_enterprise"
...
The deployed Terraform Enterprise solution provides the following capabilities:
