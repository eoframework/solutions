#------------------------------------------------------------------------------
# GCP Landing Zone DR Environment
#------------------------------------------------------------------------------
# Disaster Recovery deployment implementing GCP Well-Architected Framework:
#
# OPERATIONAL EXCELLENCE
# - Organization policies and folder hierarchy (mirrors prod)
# - Full logging and monitoring
# - DR-specific operational runbooks
#
# SECURITY
# - Cloud KMS encryption (cross-region keys)
# - Security Command Center Premium
# - Cloud Armor WAF protection (mirrors prod)
# - IAM baseline
#
# RELIABILITY
# - Shared VPC with DR subnets (different CIDR ranges)
# - Cross-region replication targets
# - Standby configuration for failover
# - Full Cloud NAT redundancy
#
# COST OPTIMIZATION
# - Standby resources until failover
...
module "organization" {
  ...
  # Organization policies - Security baseline (mirrors prod)
...
#------------------------------------------------------------------------------
# Cloud KMS Encryption (Security) - Cross-region keys
#------------------------------------------------------------------------------
module "kms" {
...
#===============================================================================
# BEST PRACTICES - Full DR configuration (mirrors prod + DR-specific)
#===============================================================================
#------------------------------------------------------------------------------
# Best Practices (SCC Premium + Cloud Armor + Budget + DR)
#------------------------------------------------------------------------------
module "best_practices" {
  ...
  # Security Configuration - Full (mirrors prod)
  security = {
  ...
  # DR Configuration - Full (this IS the DR environment)
  dr = {
