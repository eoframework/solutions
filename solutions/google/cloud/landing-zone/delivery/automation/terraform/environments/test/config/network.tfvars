...
network = {
  ...
  flow_log_aggregation_interval = "INTERVAL_10_MIN"  # Flow log aggregation interval
  flow_log_sampling = "0.5"  # Flow log sampling rate
  ...
  vpc_name = "shared-vpc-test"  # Shared VPC network name
