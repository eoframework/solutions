# IBM OpenShift Container Platform - Terraform Configuration
# Infrastructure for OpenShift cluster deployment
...
resource "aws_route_table" "private" {
  ...
  route {
    cidr_block     = "0.0.0.0/0"
    nat_gateway_id = aws_nat_gateway.openshift[count.index].id
  }
...
# IAM Roles for OpenShift
resource "aws_iam_role" "openshift_master" {
