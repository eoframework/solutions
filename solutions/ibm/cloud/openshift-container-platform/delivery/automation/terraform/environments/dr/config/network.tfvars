...
network = {
  ...
  private_subnets = ["10.2.11.0/24", "10.2.12.0/24", "10.2.13.0/24"]  # Private subnet CIDRs
  public_subnets = ["10.2.1.0/24", "10.2.2.0/24", "10.2.3.0/24"]  # Public subnet CIDRs
  service_cidr = "172.30.0.0/16"  # CIDR block for service networking
  type = "OVNKubernetes"  # OpenShift network plugin type
  vpc_cidr = "10.2.0.0/16"  # VPC CIDR block for cluster
}
